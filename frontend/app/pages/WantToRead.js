...
export default function WantToRead() {
  ...
  const [selectedSortId, setSelectedSortId] = useState(wantToReadUiState.sortId);
  ...
  const {
    ...
    { userId, status: LIBRARY_STATUS.wantToRead, page: 1, pageSize: 100 },
    { skip: !userId },
  );
  ...
  wantToReadUiState.sortId = selectedSortId;
